...
const ValorDisplay = document.getElementById('displayInput3');
...
//BOTÃO MAIS
document.getElementById('botaoMAIS3').addEventListener('click', somarBotao);
...
//BOTÃO MENOS
document.getElementById('botaoMENOS3').addEventListener('click', subtrairBotao);
...
const BotaoComprar = document.querySelector("#ComprarProduto3");
