...
const ValorDisplay = document.getElementById('displayInput4');
...
//BOTÃO MAIS
document.getElementById('botaoMAIS4').addEventListener('click', somarBotao);
...
//BOTÃO MENOS
document.getElementById('botaoMENOS4').addEventListener('click', subtrairBotao);
